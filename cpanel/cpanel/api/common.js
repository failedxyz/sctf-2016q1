...
exports.db = new mongodb.Db(process.env.MONGO_DB, new mongodb.Server(process.env.MONGO_PORT_27017_TCP_ADDR, ~~(process.env.MONGO_PORT_27017_TCP_PORT), { auto_reconnect: true }), { w: 1 });
